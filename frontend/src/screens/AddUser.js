...
export default function AddUser() {
  ...
  return (
    ...
    onSubmit={async(values) => {
      ...
      const body = {name:values.name, email:values.email, password:values.password, college:values.college, TAGID:values.TAGID }
        ...
        <div className="col-md-12">
            <div>
                ...
                <Form>
                  ...
                  <button className="btn btn-dark mt-3" type="submit">ADD STUDENT</button>
